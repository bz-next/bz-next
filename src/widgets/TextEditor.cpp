...
const TextEditor::LanguageDefinition& TextEditor::LanguageDefinition::BZW()
{
	static bool inited = false;
	static LanguageDefinition langDef;
	if (!inited)
	{
		static const char* const keywords[] = {
			"world", "options", "waterLevel", "dynamicColor", "textureMatrix", "material", "physics", "arc", "base", "box", "cone", "define", "group", "link", "mesh", "meshbox", "meshpyr", "pyramid", "sphere", "teleporter", "tetra", "weapon", "zone", "end", "enddef", "include"
		};
		...
		static const char* const identifiers[] = {
			"name", "size", "flagHeight", "noWalls", "freeCtfSpawns", "height", "materials", "red", "green", "blue", "alpha", "sequence", "sinusoid", "limits", "clampUp", "clampDown",
			"scale", "spin", "shift", "center", "fixedscale", "fixedspin", "fixedshift", "texmat", "texture", "addTexture", "notextures", "notexcolor", "notexalpha", "dyncol", "ambient", "diffuse",
			"color", "specular", "emission", "shininess", "resetmat", "spheremat", "noradar", "noshadow", "noculling", "nosorting", "alphathresh", "groupalpha", "occluder", "linear", "angular", "slide", "death",
			"phydrv", "divisions", "flatshading", "angle", "ratio", "position", "rotation", "size", "shift", "shear", "texsize", "smoothbounce", "matref", "oncap", "bottom", "team", "tint", "drivethrough",
			"shootthrough", "from", "to", "vertex", "normal", "texcoord", "inside", "noclusters", "passable", "face", "obstacle", "hemisphere", "border", "tilt", "delay", "type", "trigger", "eventteam", "zoneflag", "flag", "safety",
			"dlist", "decorative", "angvel", "extents", "corner", "lod", "lengthPerPixel", "points", "lines", "lineloop", "linestrip", "tris", "tristrip", "trifan", "quads", "quadstrip", "polygon", "flipz", "nolighting", "addtexture"
		};
		for (auto& k : identifiers)
		{
			Identifier id;
