...
class WorldPrimitiveGenerator {
    public:
        ...
        static Magnum::Trade::MeshData planarPolyFromTriFan(const std::vector<Magnum::Math::Vector3<float>> &verts, const std::vector<Magnum::Math::Vector3<float>> &norms, const std::vector<Magnum::Math::Vector2<float>> &texcoords);
        static Magnum::Trade::MeshData rawIndexedTris(const std::vector<Magnum::Math::Vector3<float>> &verts, const std::vector<Magnum::Math::Vector3<float>> &norms, const std::vector<Magnum::Math::Vector2<float>> &texcoords,  const std::vector<Magnum::UnsignedInt> &indices);
