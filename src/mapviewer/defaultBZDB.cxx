...
DefaultDBItem defaultDBItems[] =
{
    ...
    { "displayFlagHelp",      "1",            true,   StateDatabase::ReadWrite,   NULL },
    ...
    { "shotBrightness",       "0.2",          true,   StateDatabase::ReadWrite,   NULL },
    ...
    // team tank colors
    { "roguecolor",       "1 1 0",        true,   StateDatabase::ReadWrite,   NULL },
    { "redcolor",         "1 0 0",        true,   StateDatabase::ReadWrite,   NULL },
    { "greencolor",       "0 1 0",        true,   StateDatabase::ReadWrite,   NULL },
    { "bluecolor",        "0.1 0.2 1",        true,   StateDatabase::ReadWrite,   NULL },
    { "purplecolor",      "1 0 1",        true,   StateDatabase::ReadWrite,   NULL },
    { "observercolor",        "1 1 1",        true,   StateDatabase::ReadWrite,   NULL },
    { "rabbitcolor",      "0.8 0.8 0.8",      true,   StateDatabase::ReadWrite,   NULL },
    { "huntercolor",      "1 0.5 0",      true,   StateDatabase::ReadWrite,   NULL },

    // team radar colors
    { "rogueradar",       "1 1 0",        true,   StateDatabase::ReadWrite,   NULL },
    { "redradar",         "1 0.15 0.15",      true,   StateDatabase::ReadWrite,   NULL },
    { "greenradar",       "0.2 0.9 0.2",      true,   StateDatabase::ReadWrite,   NULL },
    { "blueradar",        "0.08 0.25 1",      true,   StateDatabase::ReadWrite,   NULL },
    { "purpleradar",      "1 0.4 1",      true,   StateDatabase::ReadWrite,   NULL },
    { "observerradar",        "1 1 1",        true,   StateDatabase::ReadWrite,   NULL },
    { "rabbitradar",      "1 1 1",        true,   StateDatabase::ReadWrite,   NULL },
    { "hunterradar",      "1 0.5 0",      true,   StateDatabase::ReadWrite,   NULL },
